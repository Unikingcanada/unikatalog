  ...
  useEffect(()=>{
    async function load(){
      try{
        ...
        const [intralox,unicatalog,buckets,macChains]=await Promise.all([fetchAll(CatalogProduct),fetchAll(UniCatalog),fetchAll(ElevatorBucket),fetchAll(MacChainProduct)]);
        setAllProducts([
